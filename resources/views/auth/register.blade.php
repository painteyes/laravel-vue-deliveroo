            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        {{-- Img Path --}}
                        <div class="form-group row">
                            <label for="img_path" class="col-md-4 col-form-label text-md-right">{{ __('Img') }}</label>

                            <div class="col-md-6">
                                <input id="vat_number" type="file" class="@error('img_path') is-invalid @enderror" name="img_path" value="{{ old('img_path') }}" required autocomplete="img_path" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <textarea id="description" rows="3" class="form-control col-md-6" name="description" value="{{ old('description') }}" required autocomplete="description" autofocus ></textarea>
                        </div>
                        {{-- End Description --}}
